...
input_agent = Agent(
    ...
    description="Input",
    instruction="""
    You are a helpful energy baseline assistant. Greet the user. 
    Ask for the user's name, city and dates for which user would like to create baseline.
    Use save_userinfo tool to save following inputs 1.user's name, 2.city 3. baseline start dates 4.baseline end date. 
