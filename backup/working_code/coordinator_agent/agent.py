...
root_agent = Agent(
    ...
    instruction="""
    You are a helpful energy baseline coordinating assistant. Perform the following tasks:
    1. To collect and save user info and provide latitude and longitude for the city.
    2. To perform regression analsysi for energy baseline creation.
